  ...
  return (
    <div className="min-h-screen bg-[#2a2a2a] text-white">
      ...
      <header className="p-6">
        <h1 className="text-2xl font-light tracking-wide">blueprint</h1>
      </header>
      ...
      <main className="flex-1 flex justify-center items-center p-6">
        <div className="flex gap-8 items-start">
          ...
          <iframe 
            width="560" 
            height="315" 
            src="https://www.youtube.com/embed/fVlVZTHmkaw?si=-YpjX-5VdWuPj5Ct" 
          ...
          <blockquote 
            ...
            data-instgrm-permalink="https://www.instagram.com/reel/DMH4h9RNhR9/?utm_source=ig_embed&amp;utm_campaign=loading" 
          ...
          >
            <div style={{padding:"16px"}}> 
              <a href="https://www.instagram.com/reel/DMH4h9RNhR9/?utm_source=ig_embed&amp;utm_campaign=loading" style={{ background:"#FFFFFF", lineHeight:"0", padding:"0 0", textAlign:"center", textDecoration:"none", width:"100%"}} target="_blank" rel="noopener noreferrer"> 
              ...
              <p style={{ color:"#c9c8cd", fontFamily:"Arial,sans-serif", fontSize:"14px", lineHeight:"17px", marginBottom:"0", marginTop:"8px", overflow:"hidden", padding:"8px 0 7px", textAlign:"center", textOverflow:"ellipsis", whiteSpace:"nowrap"}}>
                <a href="https://www.instagram.com/reel/DMH4h9RNhR9/?utm_source=ig_embed&amp;utm_campaign=loading" style={{ color:"#c9c8cd", fontFamily:"Arial,sans-serif", fontSize:"14px", fontStyle:"normal", fontWeight:"normal", lineHeight:"17px", textDecoration:"none"}} target="_blank" rel="noopener noreferrer">A post shared by Matter (@matter.zyx)</a>
              </p>
            </div>
          </blockquote>
          ...
          <blockquote 
            ...
            cite="https://www.tiktok.com/@grelmosss/video/7538034662522785046" 
            data-video-id="7538034662522785046" 
            style={{maxWidth: "605px", minWidth: "325px"}}
          > 
            <section> 
              <a target="_blank" title="@grelmosss" href="https://www.tiktok.com/@grelmosss?refer=embed" rel="noopener noreferrer">@grelmosss</a> 
              <p></p> 
              <a target="_blank" title="♬ Billie Jean Remix FULL REMIX ON MY YT - jiandro" href="https://www.tiktok.com/music/Billie-Jean-Remix-FULL-REMIX-ON-MY-YT-7527415303060376353?refer=embed" rel="noopener noreferrer">♬ Billie Jean Remix FULL REMIX ON MY YT - jiandro</a> 
            </section> 
          </blockquote>
        </div>
      </main>
